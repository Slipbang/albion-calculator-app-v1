...
export type TSelectCityType = 'mainMaterialCity' | 'subMaterialCity' | 'artefactCity' | 'journalCity' | 'emptyJournalCity';
...
const InfoTable = React.memo((props: IInfoTableProps) => {
    const {itemsData, materialsData, artefactsData, journalsData} = props;
